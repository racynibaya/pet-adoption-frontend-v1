...
// ── Shelter view model ────────────────────────────────────────────────────────
// Mock seed data used as a fallback when the backend /shelters endpoint is
// unreachable or returns no rows yet. The display fields (bg, svg) are not
// stored in the backend and are populated only on these seed entries.
...
export const SHELTERS: Shelter[] = [
  {
    ...
    addressLine: 'Brgy. San Agustin, Chismosa St.',
    city: 'San Fernando',
    province: 'La Union',
    region: 'LUZON',
  ...
  },
  {
    ...
    addressLine: '32nd St, Bonifacio Global City',
    city: 'Taguig',
