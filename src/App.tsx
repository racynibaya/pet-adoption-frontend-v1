...
import EmailVerifiedPage from '@/pages/Auth/EmailVerified/EmailVerified';
                  ...
                  <Routes>
                    ...
                    <Route element={<AdminLayout />}>
                      ...
                      <Route
                        ...
                        element={<AdminAdoptions />}
                      />
                      <Route
                        path='/admin/shelters'
                        element={<AdminShelters />}
                      />
                      <Route
                        path='/admin/shelters/add'
                        element={<AdminShelterForm />}
                      />
                      <Route
                    ...
                    <Route element={<StaffLayout />}>
                      ...
                      <Route
                        path='/staff/pets/add'
                        element={<StaffPetForm />}
                      />
                      <Route
                        path='/staff/pets/:id/edit'
                        element={<StaffPetForm />}
                      />
                      <Route
                        path='/staff/adoptions'
                        element={<StaffAdoptions />}
                      />
                    </Route>
                  </Routes>
                </ErrorBoundary>
