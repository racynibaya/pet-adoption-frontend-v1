  ...
  return (
    <div className='r-sticky-md'>
      ...
      >
        ...
        >
          {activeImage ? (
            ...
            <>
              ...
              />
              <div
                style={{ transform: 'scale(2.2)', transition: 'transform 400ms cubic-bezier(0.34,1.56,0.64,1)', position: 'relative', zIndex: 1 }}
        ...
        >
          <p style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.14em', color: 'var(--muted)', textTransform: 'uppercase', marginBottom: 6 }}>
            Shelter
          </p>
          <p
            style={{
      ...
      {images.length > 1 && (
        <div
          ...
          style={{ display: 'flex', gap: 10, marginTop: 16, overflowX: 'auto', paddingBottom: 4 }}
        >
          {images.map((url, idx) => {
            ...
            return (
              <button
                ...
                style={{
                  ...
                  outlineOffset: '-1px',
                  boxShadow: isActive ? '0 6px 18px rgba(232,146,60,0.22)' : 'none',
