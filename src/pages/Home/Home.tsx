  ...
  return (
    ...
    >
      {STATS.map(({ num, lab }) => (
        ...
        >
          <div className='home-stats-num'>{num}</div>
          <div className='home-stats-label'>{lab}</div>
        </div>
      ))}
    </section>
  );
    ...
    <section className='section-tight'>
      <div className='r-grid-2 gap-16 items-center home-trust-grid'>
        ...
        <div className='relative home-trust-photos' aria-hidden='true'>
          ...
          <div
            className='home-trust-card-l absolute rounded-[14px] overflow-hidden transition-[transform,box-shadow] duration-340 hover:-translate-y-1.5 hover:scale-[1.02] hover:[box-shadow:0_16px_40px_rgba(0,0,0,0.13)]'
            style={{
              left: 0,
              top: 0,
              width: 240,
        ...
        <div>
          ...
          <ul className='mt-6 flex flex-col gap-3.5'>
            {TRUST_ITEMS.map((item) => (
              ...
              >
                <span
                  className='w-5.5 h-5.5 rounded-full shrink-0 inline-flex items-center justify-center mt-px'
    ...
    <section className='section'>
      ...
      <div className='r-grid-3 gap-7'>
        {BLOG_POSTS.map(({ bg, category, readTime, title, svg }) => (
          <article
            key={title}
            className='group flex flex-col gap-3.5 cursor-pointer transition-transform duration-200 hover:-translate-y-1'
          >
            <div
