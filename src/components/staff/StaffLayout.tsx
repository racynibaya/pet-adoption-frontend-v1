...
function IconPaw() {
  return (
    <svg width="17" height="17" viewBox="0 0 24 24" fill="none">
      ...
      <path d="M12.5 11c-3.3 0-6.5 2.5-6.5 5.5 0 1.7 1.3 3 3 3 1 0 1.8-.4 2.6-.7.6-.2 1.2-.4 1.9-.4s1.3.2 1.9.4c.8.3 1.6.7 2.6.7 1.7 0 3-1.3 3-3 0-3-3.2-5.5-6.5-5.5Z" fill="currentColor" />
    </svg>
  )
}
...
const NAV = [
  ...
  { to: '/staff/adoptions', end: false, icon: <IconHeart />, label: 'Adoptions' },
]
      ...
      >
        ...
        <div style={{ padding: '22px 18px 18px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              <div style={{ color: 'white', fontWeight: 700, fontSize: 14.5, lineHeight: 1.15, fontFamily: 'var(--font-display)' }}>KodaNest</div>
              <div style={{ color: 'rgba(255,255,255,0.32)', fontSize: 9.5, fontWeight: 600, letterSpacing: '0.09em', textTransform: 'uppercase', marginTop: 1 }}>Staff Portal</div>
            </div>
          </div>
        </div>
        ...
        <div style={{ flex: 1, padding: '10px 10px' }}>
          <div style={{ marginBottom: 4, padding: '8px 8px 4px', fontSize: 9.5, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.22)' }}>
            Menu
          </div>
          {NAV.map(item => (
            <NavLink
        ...
        {/* User section */}
        <div style={{ padding: '12px 14px 22px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ color: 'rgba(255,255,255,0.88)', fontSize: 13, fontWeight: 600, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                {staffUser?.name}
              </div>
              <div style={{ color: 'rgba(255,255,255,0.35)', fontSize: 11.5, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                {staffUser?.role}
              </div>
            </div>
          </div>
